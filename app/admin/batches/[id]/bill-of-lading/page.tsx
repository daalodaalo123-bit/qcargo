      ...
      <div className="print-doc bg-white text-black min-h-screen p-10 font-sans max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-start pb-6 mb-6 border-b-[3px] border-black">
          ...
          <div className="text-right">
            <div className="text-3xl font-black uppercase tracking-widest text-black">Bill of Lading</div>
        ...
        <table className="w-full border-collapse text-sm mb-6">
          <thead>
            <tr>
              ...
              <th className="bg-black text-white text-[10px] font-black uppercase tracking-widest text-left px-3 py-2.5 border border-black">Consignee / Customer</th>
              ...
              <th className="bg-black text-white text-[10px] font-black uppercase tracking-widest text-center px-3 py-2.5 border border-black w-20">Weight (KG)</th>
              <th className="bg-black text-white text-[10px] font-black uppercase tracking-widest text-center px-3 py-2.5 border border-black w-20">CBM</th>
            </tr>
          </thead>
          <tbody>
            {shipments.length === 0 ? (
