...
export default function ExpenseFinancialIntel({
  expenses,
  shipments = [],
  showNetMargin = false,
  ...
  const insights = useMemo(() => {
    ...
    if (showNetMargin && margin.shipmentCount > 0) {
      lines.push(
    ...
    return lines;
  }, [stats, paidShare, changeVsLastMonth, lastStats.total, margin, showNetMargin]);
